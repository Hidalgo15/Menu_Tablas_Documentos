# Visor de Documentos de la Contraloría General de la República Dominicana

Aplicación web desarrollada en ASP.NET Core MVC para consultar, listar y visualizar documentos almacenados en una base de datos. La solución permite cargar una colección de registros asociados a una tabla y un código, y luego abrir cada documento en formato PDF a partir de un archivo binario comprimido en ZLIB.

## Descripción general

El proyecto está pensado para operar como un visor documental sobre un catálogo de documentos persistidos en una base de datos. En lugar de mantener archivos físicos en disco, el sistema extrae el contenido desde la base de datos, lo descomprime mediante una librería nativa y lo entrega al navegador como flujo PDF.
...
- `123`: código asociado a la colección de documentos
...
1. La descompresión depende de una DLL específica y de una arquitectura de 32 bits.
2. No hay pruebas automatizadas en la solución en este momento.
